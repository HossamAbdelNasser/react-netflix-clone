...
const ListItem = ({index}) => {
  ...
  return (
    ...
    onMouseEnter={()=>setIsHovered(true)}
     ...
     >
      <img src="https://samepageteam.files.wordpress.com/2013/09/bb-ozymandius.jpg" alt="" />
